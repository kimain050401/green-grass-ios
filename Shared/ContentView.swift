...
struct ContentView: View {
    ...
    @State var progressCommitDayValue: Float = 0.0
    @State var progressCommitMaintainValue: Float = 0.0
    ...
    @State var commitMaintain: Int = 0
    ...
    @State var commitMaintainCheerTextRandomNumber = Int.random(in: 0...10)
    @State var commitMaintainCheerText : [String] = ["잘하고 있어요! 앞으로도 이대로만 쭉!", "까먹지 말고 매일매일 1일 1커밋 하기!", "지금까지 너무 잘하고 있어요! 화이팅!", "커밋을 생활화하면 뭔들 안 좋겠어요?!", "내일도 1일 1커밋 하기! 잊지 마세요!", "내일도 모레도 잊지 말고 꼭 커밋하기!", "커밋 습관 들이는 당신, 너무 멋져요!", "매일 열심히 커밋하는 당신, 칭찬해요!", "앞으로도 커밋 잊으면 안 돼요! 화이팅!", "1일 1커밋을 달성하는 당신, 멋있어요!", "지금까지 한 것처럼 앞으로도 화이팅!"]
    ...
    func getGithubContributions(isAll: Bool){
        loading = true
        commitMaintainCheerTextRandomNumber = Int.random(in: 0...10)
